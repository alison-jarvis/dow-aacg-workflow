from Minimization import CG_AA_Minimizer
import argparse
...
if __name__ == '__main__':
    ...
    # Define coarse grained minimization object
    cg_minimizer = CG_AA_Minimizer(system_config_path, general_config_path)

    # Minimize
    cg_minimizer.minimize()